...
Тем не менее мы видим что в нашем саттелите есть строки с start_date = 1996-01-01
![Скриншот](screenshots/34.png)

А это значит “вставка новых версий” отработала.


### 5. Итоги работы
- В рамках итогового задания был успешно спроектирован и реализован слой DDS (Detail Data Storage) по методологии Data Vault с использованием SQL-движка Trino.
- В качестве источника использован учебный набор TPC-H (схема tpch.tiny).
- На основании исходной реляционной модели TPC-H была разработана Data Vault-модель, включающая Хабы, Линки и Саттелиты
